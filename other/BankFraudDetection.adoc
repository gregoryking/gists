...
==== Set those that are greater than 2 standard deviations from the mean

[source,cypher]
----
MATCH 		(a:BankAccount)
WITH  		a, stdev(a.Balance) as accBalStDev, avg(a.Balance) as accBalAvg
RETURN a, accBalStDev, accBalAvg
----
